...
@Entity('repo_symbol_var_output')
export class SymbolBlockVarOutputEntity extends SymbolBlockVarEntity {
  @Column()
  value!: string // 设置值
  ...
  @ManyToOne(() => SymbolBlockVersionEntity, (sb) => sb.outputs, { onDelete: 'CASCADE' })
